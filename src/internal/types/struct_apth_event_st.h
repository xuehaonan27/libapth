...
#define APTH_GOAL_UNTIL_TID_NEW _BIT(1)
#define APTH_GOAL_UNTIL_TID_READY _BIT(2)
#define APTH_GOAL_UNTIL_TID_WAITING _BIT(3)
#define APTH_GOAL_UNTIL_TID_TERMINATED _BIT(4)
#define APTH_GOAL_UNTIL_TID_WAKED _BIT(5)
#define APTH_GOAL_UNTIL_TID_RUNNING _BIT(6)
