...
// TODO: for signals like SIGKILL, SIGSTOP, SIGSEGV, SIGBUS, SIGFPE, SIGILL
...
// TODO: forward calling `pthread_sigmask` and `sigprocmask` to `apth_sigmask`
...
// TODO: implement this
extern apth_event_custom_func_t __apth_sigsuspend_check;
